...
class CONC_TIMESERIES(models.Model):
    ...
    Time = ArrayField(models.CharField(max_length=15), blank=True, null=True)
    Obs_conc = ArrayField(models.CharField(max_length=15), blank=True, null=True)
    Conserv_conc = ArrayField(models.CharField(max_length=15), blank=True, null=True)
    Disch_adj_conc = ArrayField(models.CharField(max_length=15), blank=True, null=True)
